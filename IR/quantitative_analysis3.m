...
%[X_dig,Y_dig]=meshgrid(1:1280, 1:1024);
...
%[X_trad,Y_trad]=meshgrid(1:1280, 1:1024);
...
figure;
XcM=XcM(100:end,100:end);
YcM=YcM(100:end,100:end);
Spz=Spz(100:end,100:end);
...
a = imbinarize(z_sin_perfil1, 'adaptive', 'Sensitivity', 0.000000, 'ForegroundPolarity', 'dark');
